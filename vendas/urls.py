...
urlpatterns = [
    ...
    path('adicionar-endereco-checkout/', views_principais.adicionar_endereco_checkout, name='adicionar_endereco_checkout'),
    ...
    path('teste-conexao/', views_principais.teste_conexao_mp, name='teste_conexao'),
